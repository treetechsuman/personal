	...
	<div class="about" id="about">
		...
		<div class="w3l-grids-about">
				...
				<div class="col-md-7 w3ls-agile-left">
					...
					<div class="w3ls-agile-left-info">
						<h4>Email Address</h4>
						<p><a href="mailto:example@email.com">me.suman11@gmail.com</a></p>
					</div>
				</div>
				<div class="clearfix"> </div>
			</div>
...
<!-- /education -->
 <div class="education" id="education">
			  ...
			  <div class="education-agile-grids">
				  <div class="education-agile-w3l">
				     <div class="education-agile-w3l-year">
					       <h4>2010-2014</h4>
						   <h6>BE information technology</h6>
				     </div>
		...
		<h3 class="w3l_head two">My Skills</h3>
	     <div class="skill-agile">
						...
						<div class='bar_group__bar thin elastic' label='Css3' value='220'></div>
						<div class='bar_group__bar thin elastic' label='Js' value='250'></div>
 ...
 <div class="education" id="education two">
		...
		<div class="col-sm-4 abt-gd-left text-center">		   
			<div id="demo-pie-4" class="pie-title-center" data-percent="45"> <span class="pie-value"></span> </div>
			...
			<p class="w3ls_head_para">See My Works</p>
				...
				<div class="col-md-4 agileits_portfolio_grid">
					<div class="agileinfo_portfolio_grid hovereffect">
						<a class="cm-overlay" href="images/portfolio1.jpg">
							<img src="images/portfolio1.jpg" alt=" " class="thumbnail img-responsive">
							<div class="overlay">
								<h4>Classy Resume</h4>
					...
					<div class="agileinfo_portfolio_grid hovereffect">
						<a class="cm-overlay" href="images/portfolio2.jpg">
							<img src="images/portfolio2.jpg" alt=" " class="thumbnail img-responsive">
							<div class="overlay">
								<h4>Classy Resume</h4>
					...
					<div class="agileinfo_portfolio_grid hovereffect">
						<a class="cm-overlay" href="images/portfolio3.jpg">
							<img src="images/portfolio3.jpg" alt=" " class="thumbnail img-responsive">
							<div class="overlay">
								<h4>Classy Resume</h4>
				...
				<div class="col-md-4 agileits_portfolio_grid">
					<div class="agileinfo_portfolio_grid hovereffect">
						<a class="cm-overlay" href="images/portfolio4.jpg">
							<img src="images/portfolio4.jpg" alt=" " class="thumbnail img-responsive">
							<div class="overlay">
								<h4>Classy Resume</h4>
					...
					<div class="agileinfo_portfolio_grid hovereffect">
						<a class="cm-overlay" href="images/portfolio5.jpg">
							<img src="images/portfolio5.jpg" alt=" " class="thumbnail img-responsive">
							<div class="overlay">
								<h4>Classy Resume</h4>
					...
					<div class="agileinfo_portfolio_grid hovereffect">
						<a class="cm-overlay" href="images/portfolio6.jpg">
							<img src="images/portfolio6.jpg" alt=" " class="thumbnail img-responsive">
							<div class="overlay">
								<h4>Classy Resume</h4>
				...
				<div class="col-md-4 agileits_portfolio_grid">
					<div class="agileinfo_portfolio_grid hovereffect">
						<a class="cm-overlay" href="images/portfolio7.jpg">
							<img src="images/portfolio7.jpg" alt=" " class="thumbnail img-responsive">
							<div class="overlay">
								<h4>Classy Resume</h4>
					...
					<div class="agileinfo_portfolio_grid hovereffect">
						<a class="cm-overlay" href="images/8.jpg">
							<img src="images/8.jpg" alt=" " class="thumbnail img-responsive">
							<div class="overlay">
								<h4>Classy Resume</h4>
					...
					<div class="agileinfo_portfolio_grid hovereffect">
						<a class="cm-overlay" href="images/9.jpg">
							<img src="images/9.jpg" alt=" " class="thumbnail img-responsive">
							<div class="overlay">
								<h4>Classy Resume</h4>
			...
			<div class="w3ls_footer_grids">
				...
				<div class="w3ls_footer_grid">
					...
					<div class="col-md-4 w3ls_footer_grid_left">
						...
						<div class="w3ls_footer_grid_leftr">
							<h4>Email</h4>
							<a href="mailto:info@example.com">me.suman11@gmail.com</a>
						</div>
						<div class="clearfix"> </div>
					</div>
					<div class="col-md-4 w3ls_footer_grid_left">
