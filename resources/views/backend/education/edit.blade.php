				...
				<div class="box-body">
					<form role="form" action="{{url('admin/education/update/'.$education['id'])}}" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="text" class="form-control" id="start" placeholder="Enter start" name="start" value="{{$education['start']}}" required>
								@if ($errors->has('start'))
									<span class="help-block" style="color: #cc0000">
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="text" class="form-control" id="end" placeholder="Enter end" name="end" value="{{$education['end']}}" required>
								@if ($errors->has('end'))
									<span class="help-block" style="color: #cc0000">
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="number" class="form-control" id="display_order" placeholder="Enter Name" name="display_order" value="{{$education['display_order']}}" required>
