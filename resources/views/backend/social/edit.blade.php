	...
	<div class="row">
		<div class="col-md-6">
			<div class="box box-primary">
				...
				<div class="box-body">
					<form role="form" action="{{url('admin/social/update/'.$social['id'])}}" method="post" enctype="multipart/form-data">
						{!! csrf_field() !!}
						<div class="form-group">
							...
							<div class="col-md-9">
								...
								<input type="text" class="form-control" id="icon" placeholder="Enter Name" name="icon" value="{{$social['icon']}}" required>
								@if ($errors->has('icon'))
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="text" class="form-control" id="link" placeholder="Enter Name" name="link" value="{{$social['link']}}" required>
								@if ($errors->has('link'))
									<span class="help-block" style="color: #cc0000">
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="number" class="form-control" id="display_order" placeholder="Enter Name" name="display_order" value="{{$social['display_order']}}" required>
