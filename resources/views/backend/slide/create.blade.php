	...
	<div class="row">
		<div class="col-md-6">
			<div class="box box-primary">
				...
				<div class="box-body">
					<form role="form" action="{{url('admin/slide/store')}}" method="post" enctype="multipart/form-data">
						{!! csrf_field() !!}
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="text" class="form-control" id="content" placeholder="Enter Name" name="content" value="{{old('content')}}" required>
